...
import (
	...
	"syscall"
	"time"
	"web_app_scaffolding/dao/mysql"
	"web_app_scaffolding/dao/redis"
	"web_app_scaffolding/logger"
	"web_app_scaffolding/routes"
...
func main() {
	...
	// signal.Notify 把收到的 syscall.SIGINT或syscall.SIGTERM 信号转发给quit
